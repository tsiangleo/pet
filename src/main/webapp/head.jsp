...
%>
   ...
   <%  
    ...
    %> 
     <a href="lookcar.jsp">我的购物车</a> <a href=loginout.jsp>注销</a>
 <%}
  else
  { %>
  ...
  <tr>
    ...
    <td   background="searchgif.gif"width="500" height="80">
      <table width="100%" border="0" cellspacing="0" cellpadding="1">
        ...
        <tr>
          <td><form id="head_search" name="head_search" method="post" action="dosearch.jsp?pageid=0">
             <label for="textfield"></label>
            <input type="text" name="petname" id="petname"  size="50" /></td>
           </form>
          <td><a href="javascript:;" onclick="document.head_search.submit();"><img  border="0" src="images/searchbutton.gif" width="40" height="20" alt="搜索" /></a></td>
        </tr>
        <tr>
          <td>&nbsp;&nbsp; </td>
          <td>&nbsp;</td>
...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr  style="background:url(images/daohangbeijing.gif)">
    ...
    <td width="150" height="50" align="center"><a href="looknews.jsp" target="_self" onmouseover="MM_swapImage('petbaike','','images/42.gif',1)" onmouseout="MM_swapImgRestore()"><img src="images/41.gif" alt="链接到宠物百科" name="petbaike" width="100" height="38" border="0" id="petbaike" /></a></td>
